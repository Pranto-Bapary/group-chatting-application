...
public class Client2 implements ActionListener, Runnable {
    ...
    // Initializing position variables to control window movement
    ...
    Client2() {
        ...
        p1.setBackground(new Color(50, 133, 50));
        ...
        nameLabel.setBounds(120, 23, 120, 18);
        nameLabel.setForeground(Color.YELLOW);
        nameLabel.setFont(new Font("SAN_SERIF", Font.BOLD, 16));
        p1.add(nameLabel);

        JLabel status = new JLabel("Lamia, Pranto, Rakib, and others");
        status.setBounds(120, 43, 200, 18);
        ...
        f.setSize(450, 650);
        f.setLocation(465, 50);  // Shift window to the right (Increase X value)
        f.setUndecorated(true);
        f.getContentPane().setBackground(Color.WHITE);
        f.setVisible(true);

        // Adding mouse listener to move the window manually
        ...
        f.addMouseMotionListener(new MouseAdapter() {
            public void mouseDragged(MouseEvent e) {
                ...
                f.setLocation(x - xMouse, y - yMouse); // Move window based on mouse drag
            }
        });
